...
From 8.9.1, the **[!UICONTROL SQL code]** and **[!UICONTROL SQL Data Management]** workflow activities have been improved to better protect PostgreSQL databases and keep your workflows running smoothly when custom SQL is executed from Campaign.
...
Refer to [SQL code](sql-code-and-javascript-code.md#important-notes) for more details and best practices.
