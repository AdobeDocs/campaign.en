...
[Learn more](https://experienceleague.adobe.com/en/tools/campaign-api){target="_blank"} about static and non-static SOAP methods.
...
Use the `DeleteCollection` method. [Learn more](https://experienceleague.adobe.com/en/tools/campaign-api){target="_blank"}.
...
The loop includes a local recipient variable. For each recipient that is returned in the collection of recipients, the recipient's email is printed out. [Learn more](https://experienceleague.adobe.com/en/tools/campaign-api){target="_blank"} about the `logInfo` function.
...
* To post an event, you can use the static `PostEvent` method. [Learn more](https://experienceleague.adobe.com/en/tools/campaign-api){target="_blank"}.
...
1. Define the query:
   ...
   * Retrieve an entity by using the `create` method on the corresponding schema—for example, the `xtk:workflow` schema. [Learn more](https://experienceleague.adobe.com/en/tools/campaign-api){target="_blank"}.
   * Use the `queryDef` method to issue an SQL query.

1. Run the query using the `ExecuteQuery` method. [Learn more](https://experienceleague.adobe.com/en/tools/campaign-api){target="_blank"}.
...
* [Samples of SOAP calls](https://experienceleague.adobe.com/en/tools/campaign-api){target="_blank"}
* Methods:
  * [Create](https://experienceleague.adobe.com/en/tools/campaign-api){target="_blank"}
...
* [logInfo function](https://experienceleague.adobe.com/en/tools/campaign-api){target="_blank"}
