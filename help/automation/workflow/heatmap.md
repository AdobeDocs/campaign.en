...
* Filter by workflow type: [technical workflows](technical-workflows.md) or [campaign workflows](campaign-workflows.md)
* Look for a specific workflow to analyze

>[!NOTE]
>
>In addition to the **Workflow Heatmap**, you can create a workflow that will let you monitor the status of a set of workflows and send recurring messages to supervisors. For more on this, refer to the [dedicated section](workflow-supervision.md).

Using the Workflow HeatMap requires to have a good understanding of the following concepts: [Workflows](about-workflows.md), [Activities](activities.md) and [Workflow Best Practices](workflow-best-practices.md).
