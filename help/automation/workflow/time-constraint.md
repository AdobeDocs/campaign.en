...
Enter the label for the activity and specify the time frame during which the workflow task is allowed to execute. The workflow will only run during this defined execution window and will remain paused outside of it.
