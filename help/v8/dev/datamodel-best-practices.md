...
In the context of an [Enterprise (FFDA) deployment](../architecture/enterprise-deployment.md), Adobe Campaign primary key is an auto-generated UUID for all built-in tables. A UUID can also be used for custom tables. [Learn more](keys.md)
