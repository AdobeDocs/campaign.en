...
Use permissions on folders to organize and control access to Campaign data. Learn more about permissions on folders in [this section](../start/folder-permissions.md).
