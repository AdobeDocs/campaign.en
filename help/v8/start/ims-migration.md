...
You can also update the technical operator programaticaly, using SQL scripts or Campaign APIs. These modes help you to automates the steps which update operator's name with associated Technical account email address and/or authentication type. 
