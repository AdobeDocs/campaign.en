...
* [Dynamic Reporting](https://experienceleague.adobe.com/docs/campaign-web/v8/reports/dynamic-reporting/get-started-reporting.html){target="_blank"} (on demand)
* [Centralized Branding](https://experienceleague.adobe.com/docs/campaign-web/v8/conf/branding/branding-gs.html){target="_blank"} (on demand, new implementations)
...
* A revamped version of the inbox rendering report is now available in the Adobe Campaign client console. 
