...
![mirror link sample](assets/mirror-page-link.png){width="600"}
...
For more on inserting personalization content blocks, refer to [Personalization blocks](personalization-blocks.md).
