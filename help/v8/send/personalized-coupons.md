...
>[!AVAILABILITY]
>
>Coupon management is not available in Campaign v8 in the context of an Enterprise (FFDA) deployment. Learn more in [Campaign v8 documentation](../architecture/enterprise-deployment.md).
