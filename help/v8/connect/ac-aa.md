...
💬 As a Managed Cloud Services user, [contact Adobe](../start/support.md#support) to implement Experience Cloud triggers with Campaign.
...
💬 As a Managed Cloud Services user, [contact Adobe](../start/support.md#support) to integrate Adobe Analytics Data Connector with Campaign.
