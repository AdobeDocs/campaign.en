...
Get a glimpse of the newest enhancements in Adobe Campaign v8! For a comprehensive list of features, improvements, and fixes, check out the detailed [Release Notes](start/release-notes.md).
