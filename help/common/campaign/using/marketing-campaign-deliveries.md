...
The suggested configurations are suited to the different types of delivery: direct mail, email, mobile channels. [Learn more](../../../common/delivery/using/comminication-channels.md).
