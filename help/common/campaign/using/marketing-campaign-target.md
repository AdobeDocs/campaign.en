...
* Seed addresses - Learn more in [this section](../../../common/delivery/using/about-seed-addresses.md).
...
To build the delivery target, you can define filtering criteria for the recipients in the database. This recipient selection mode is presented in [this section](../../../common/delivery/using/steps-defining-the-target-population.md).
