...
1. Create the newsletter subscription service to be offered to your recipients. For more information on how to create a newsletter, refer to [this section](../../../common/delivery/using/about-services-and-subscriptions.md).
