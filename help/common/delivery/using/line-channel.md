...
>[!CAUTION]
>
>[!DNL LINE] channel is only available for on-premise or managed services installations.

## Set up LINE channel {#setting-up-line-channel}

Before creating a [!DNL LINE] account and external account, you first need to install the LINE package on your instance. 

As a hosted customer, contact Adobe to install LINE channel on your environments. As a Campaign v7 on-premise customer, refer to [this section](../../../v7/installation/using/installing-campaign-standard-packages.md#line-package).
...
### Create and configure a LINE service {#configure-line-service}

To create your [!DNL LINE] service: 

1. From the Adobe Campaign homepage, select the **[!UICONTROL Profiles and Targets]** tab.
...
### Configure the LINE external account {#configure-line-external}
...
1. In the delivery editor, select **[!UICONTROL To]** to target the recipients of your [!DNL LINE] delivery. Targeting is carried out on **[!UICONTROL Visitor subscriptions (nms:visitorSub)]**.
   ...
   For more information, refer to [this page](steps-defining-the-target-population.md). 
...
1. From your delivery editor, click **[!UICONTROL Add]** to add one or multiple message and select the **[!UICONTROL Content type]**. 
   ...
   For more information on the different **[!UICONTROL Content type]** available, refer to [this section](#defining-the-content).
...
1. When your delivery is created and configured correctly, you can send it to the target defined earlier. 
   ...
   For more information on sending a delivery, refer to [this page](email/sending-messages.md).

1. After sending your message, access your report to measure the effectiveness of your delivery. 
   
   For more information on [!DNL LINE] reports, refer to [this section](#accessing-reports).
...
The configuration for this type of message is similar to the configuration of the **[!UICONTROL Text]** in an email. For more information, refer to this [page](email/defining-the-email-content.md#message-content).
