...
description: Learn how to use a content template in the Content Manager
audience: delivery
...
They can also be used to create content instances. Once they have been created, these instances are ready to be delivered - [Learn more](#delivering-a-content-instance) - or exported - [Learn more](#creating-a-content-instance).

## Create a delivery via content management {#creating-a-delivery-via-content-management}
...
For more on this, refer to the full implementation in [this example](use-case--creating-content-management.md#creating-content-in-the-delivery-wizard).

## Create a content instance {#creating-a-content-instance}
...
1. If necessary, once the content is approved it can be generated using the appropriate button on the toolbar.
   ...
   >[!NOTE]
   >
   >You can authorize the generation of non-approved contents. To do this, change the relevant option in the publication template. [Learn more](publication-templates.md#creating-and-configuring-the-template).
...
## Deliver a content instance {#delivering-a-content-instance}

To create a content instance and deliver it, a delivery template needs to be linked to the publication template used to generate this content. For more on this, refer to [this page](publication-templates.md#delivery).
