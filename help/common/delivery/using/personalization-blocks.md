---
product: campaign
title: Insert a personalization block
description: Learn how to insert a personalization block
audience: delivery
...
Personalization blocks are accessed via the **[!UICONTROL Resources > Campaign Management > Personalization blocks]** node of the Adobe Campaign explorer. Several blocks are available by default. [Learn more](#out-of-the-box-personalization-blocks)

You can create new personalization blocks for additional personalization capabilities. [Learn more](#defining-custom-personalization-blocks).
...
## Insert a personalization block {#inserting-personalization-blocks}
...
1. The **[!UICONTROL Other...]** menu gives access to all the out-of-the-box and custom personalization blocks. [Learn more](#out-of-the-box-personalization-blocks)
...
## Personalization blocks sample {#personalization-blocks-example}

In this sample, you create an email in which you use personalization blocks to enable the recipient to view the mirror page, share the newsletter on social networks, and unsubscribe from future deliveries.

To do this, insert the following personalization blocks:
...
## Built-in personalization blocks {#built-in-personalization-blocks}
...
* **[!UICONTROL Registration page URL]** : inserts a subscription URL. [Learn more](about-services-and-subscriptions.md).
...
* **[!UICONTROL Social network sharing links]** : inserts buttons that enable the recipient to share a link to the mirror page content with the email client, Facebook, Twitter, and LinkedIn. [Learn more](viral-and-social-marketing.md#viral-marketing--forward-to-a-friend).
