...
1. In the **[!UICONTROL Mobile]** tab, select **[!UICONTROL Extended generic SMPP]** from the **[!UICONTROL Connector]** drop-down list.
   ...
   >[!CAUTION]
   >
   > As of Campaign Classic v7 release 20.2, legacy connectors are deprecated and not supported. We recommend using the **[!UICONTROL Extended generic SMPP]** connector. For more information on how to migrate to the recommended connector, refer to this [page](unsupported-connector-migration.md).
