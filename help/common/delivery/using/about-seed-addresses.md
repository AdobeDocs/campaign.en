---
product: campaign
title: Get started seed addresses
description: Learn how to use seed addresses in Adobe Campaign deliveries
audience: delivery
...
* Random substitution of fields with data taken from recipient profiles: this lets you enter only the email address, for instance in the seed address section, and let Campaign automatically fill in the other fields form the profile. [Learn more in this use case](use-case--configuring-the-field-substitution.md)).
...
>
>An example of how to extend the seed addresses table is presented in [this use case](use-case--selecting-seed-addresses-on-criteria.md).
