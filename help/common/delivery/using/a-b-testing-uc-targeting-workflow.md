...
1. If you haven't already done so, create a campaign. [Learn more](../../campaign/using/setting-up-marketing-campaigns.md#creating-a-campaign)
...
1. Change the label of the existing workflow or click **[!UICONTROL Add]** to create a new one. [Learn more](../../campaign/using/marketing-campaign-deliveries.md#selecting-the-target-population)
