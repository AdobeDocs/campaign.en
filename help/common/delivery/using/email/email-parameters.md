---
product: campaign
title: Configure email parameters in Adobe Campaign
...
>
>As a Campaign Classic v7 on-premise customer, for more information on Email BCC configuration and best practices, refer to [this section](../../../../v7/installation/using/email-archiving.md).
...
1. Select the delivery template of your choice or duplicate the out-of-the-box **Email delivery** template, then select the duplicated template.
...
By default, the mirror page is generated if the link is inserted in the content of the mail. For more on personalization blocks, refer to [this section](../personalization-blocks.md).
