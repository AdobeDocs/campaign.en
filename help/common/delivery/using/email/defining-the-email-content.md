...
The header parameters must not be empty. By default, they contain the values defined in the deployment wizard. [Learn more](../../../../v7/installation/using/deploying-an-instance.md).

>[!CAUTION]
>
>* The sender's address is mandatory and is used for replies by default.
>* To preserve your email reputation and increase deliverability, Adobe recommends creating email accounts that correspond to the addresses specified for sending and replies.
