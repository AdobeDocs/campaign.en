...
>[!IMPORTANT]
>
>The Adobe Campaign Enhanced MTA is only available for Campaign hosted or hybrid customers. Campaign on-premise installations cannot be upgraded to use the Enhanced MTA.

If you were provisioned a Campaign instance after September 2018, you are using the Enhanced MTA. For all other Campaign Classic customers, see the [Frequently asked questions](#enhanced-mta-faq) below.
...
As a hybrid client, the Adobe Campaign team will provide you with instructions on how to install the **[!UICONTROL Typology]** package on your marketing instance as part of the upgrade to the Enhanced MTA. Contact your account executive to get the full instructions.

For more on typologies, see [this section](../../../../v7/campaign-opt/using/about-campaign-typologies.md).
