...
* **[!UICONTROL Save as template]**
  ...
  The **[!UICONTROL Mass update of selected lines]** and **[!UICONTROL Merge selected lines]** options are generic platform options available in all **[!UICONTROL Actions]** menus. For more on this, refer to [this section](../../profiles/using/updating-data.md).
