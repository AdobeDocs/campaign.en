...
* **Action**: the resulting content can be saved or generated.
  ...
  For more on configuring and using content management in Adobe Campaign, refer to this [section](../../../v7/delivery/using/about-content-management.md).
...
Examples are provided in this [section](../../../v7/delivery/using/automating-via-workflows.md#examples).
