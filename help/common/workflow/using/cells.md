...
Entry form personalization in Adobe Campaign is reserved for expert users. For more on this, refer to this [section](../../../v7/configuration/using/identifying-a-form.md).
