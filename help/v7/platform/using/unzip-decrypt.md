...
Adobe Campaign lets you import zipped or encrypted files. Before they can be read in a [Data loading (file)](../../../common/workflow/using/data-loading--file-.md) activity, you can define a pre-processing to unzip or to decrypt the file.
...
* [Zip or encrypt a file](../../../common/workflow/using/how-to-use-workflow-data.md#zipping-or-encrypting-a-file).
...
1. Open the **[!UICONTROL File transfer]** activity then specify the external account from which you want to import the encrypted .gpg file.
     ...
     Global concepts on how to configure the activity are available in [this section](../../../common/workflow/using/file-transfer.md).

1. Open the **[!UICONTROL Data loading (file)]** activity, then configure it according to your needs. Global concepts on how to configure the activity are available in [this section](../../../common/workflow/using/data-loading--file-.md).
