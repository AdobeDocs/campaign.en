...
For more on using the read list activity in a workflow, refer to [this page](../../../common/workflow/using/read-list.md).
...
A description of the loading data activity can be found in the [Data loading (file)](../../../common/workflow/using/data-loading--file-.md) section.
...
Once data has been collected you can use it in your workflows, for example to enrich a delivery or update the database. For more on this, refer to [this page](../../../common/workflow/using/how-to-use-workflow-data.md).
...
Export operations are performed using a **[!UICONTROL Data extraction (file) activity]**. For more on how to configure and use the activity, refer to [this page](../../../common/workflow/using/extraction--file-.md).
