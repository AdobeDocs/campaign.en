...
>
>* Before starting, make sure the Adobe Identity Management System (IMS) is implemented in Campaign. [Learn more in this page](../../../v7/installation/using/about-adobe-id.md).
