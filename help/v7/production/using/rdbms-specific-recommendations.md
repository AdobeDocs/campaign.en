...
>* This maintenance operation can be implemented by an Adobe Campaign workflow, using an **). Make sure you schedule maintenance for a low activity time which does not collide with your backup window.
>
