...
>[!CAUTION]
>
>Once the mid-sourcing server has been setup and the [sync workflows](../../../common/workflow/using/about-technical-workflows.md) have run for the first time, make sure you do not update the internal name of the mid-sourcing external accounts.
