...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> Enables you to analyze and measure data, calculate statistics, simplify and optimize report creation and calculation. Also, you can create reports and build target populations. Optional. <a href="../../../common/reporting/using/about-cubes.md">Learn More</a><br /> </td> 
   <td> Marketing<br /> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> Provides the Federated Data Access (FDA) option in order to process information stored in one or more external databases so that you can access external data without changing the structure of Adobe Campaign data.  Optional. <a href="../../../common/workflow/using/accessing-an-external-database--fda-.md">Learn More</a> <br /> </td> 
   <td> All<br /> </td> 
  </tr> 
  <tr> 
   <td> Campaign Optimization<br /> </td> 
   <td> Controls, filters and monitors the sending of deliveries so that the messages sent best meet the needs and expectations of customers, in keeping with company communication policies. Optional. <a href="../../../v7/campaign-opt/using/about-campaign-typologies.md">Learn More</a> <br /> </td> 
   <td> Marketing<br /> </td> 
  </tr> 
  <tr> 
