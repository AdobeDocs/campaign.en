...
For more on this, see [Create a subscription form with double opt-in](../../../common/web/using/use-cases--web-forms.md#create-a-subscription--form-with-double-opt-in).
