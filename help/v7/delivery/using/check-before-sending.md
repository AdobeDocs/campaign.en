...
* In the [typology](../../../v7/campaign-opt/using/about-campaign-typologies.md) of your choice, use the **[!UICONTROL Managing affinities with IP addresses]** field to link deliveries to the delivery server (MTA) which manages the said affinity. [Learn more](../../../common/campaign-opt/using/applying-rules.md#control-outgoing-smtp-traffic).
