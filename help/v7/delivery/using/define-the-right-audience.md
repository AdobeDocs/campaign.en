...
* [Deduplication activity](../../../common/workflow/using/deduplication.md).
* [Use case: Using the Deduplication activity's merge functionality](../../../common/workflow/using/deduplication-merge.md)
