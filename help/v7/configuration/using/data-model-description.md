...
This set of tables is linked to the **Campaign Optimization** module, which allows to control, filter and monitor the sending of deliveries. For more on this, see [About campaign typologies](../../../v7/campaign-opt/using/about-campaign-typologies.md).
