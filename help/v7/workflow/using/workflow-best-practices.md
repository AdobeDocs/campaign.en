...
To learn how to purge your logs, refer to this [documentation](../../workflow/using/starting-a-workflow.md).
...
Regularly check the **[!UICONTROL Monitoring]** tab to view the overall status of the active workflows. For more on this, refer to [Instance supervision](../../workflow/using/monitoring-workflow-execution.md#instance-supervision).
